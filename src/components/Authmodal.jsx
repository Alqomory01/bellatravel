    ...
    <div>
      ...
      bg-white rounded-xl overflow-hidden">
        ...
        overflow-y-auto">
          ...
          <h2 className="text-black text-xl  sm:text-2xl font-semibold mb-2">
            Sign In / Register
          </h2>
          ...
          <button className="text-black w-full  flex items-center justify-center gap-2 border py-3 rounded-md hover:bg-gray-50">
